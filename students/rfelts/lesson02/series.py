...
def fibonacci(n):
    ...
    Parameters:
    arg1 (int) The desired positon in the fibonacci series
...
def lucas(n):
    ...
    Parameters:
    arg1 (int) The desired positon in the lucas series
...
def sum_series(n, seriesA=0, seriesB=1):
    """

    Return the fibonacci or lucas number in the series of the value passed in.

    Parameters:
    arg1 (int) The desired positon in the series
    arg2 (int) The first number in the series
    arg3 (int) The second number in the series
    ...
    if n == 0:
        ...
        return (sum_series(n - 1, seriesA, seriesB) +
                sum_series(n - 2, seriesA, seriesB))
...
# Testing the lucas function by testing the starting valuse and another value.
...
assert fibonacci(5) == sum_series(5), ("The values returned do not match. "
                                       "Test failed!")

# Testing the sum_series function against the lucas function
assert lucas(5) == sum_series(5, 2, 1), ("The values returned do not match. "
                                         "Test failed!")
...
for i in range(10):
    assert fibonacci(i) == fib[i], ("The return value is incorrect. Test "
                                    "failed!")
    assert lucas(i) == luc[i], ("The return value is incorrect. Test failed!")
    assert fibonacci(i) == sum_series(i), ("The values returned do not match. "
                                           "Test failed!")
    assert lucas(i) == sum_series(i, 2, 1), ("The values returned do not "
                                             "match. The test failed.")
