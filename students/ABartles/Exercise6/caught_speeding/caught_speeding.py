...
def caught_speeding(speed, is_birtday):
    if speed < 61 or (is_birtday and speed < 66):
        return 0
    elif 61 <= speed <= 80 or (is_birtday and 66 <= speed <= 85):
        return 1
    elif speed > 80 or (is_birtday and speed > 85):
        return 2
