...
------------------------------------------------------------------'''
    ...
    for donor in report_list:
        total_donations = format(donor[0], '.2f')
        number_donations = len(donor_list[donor[1]])
        average = format(total_donations/number_donations, '.2f')
        print(strformat.format(donor[1].title(),total_donations, number_donations, average))
