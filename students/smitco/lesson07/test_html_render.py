...
# !/usr/bin/env python3
# derived from class provided pytest file
...
def test_render_element():
    ...
    """
    # changed to Body to support Element tag_name = ""
...
def test_title():
    e = Title("this is some one line text")

    file_contents = render_result(e).strip()

    assert("<title>this is some one line text</title>") in file_contents
...
def test_kwargs():
    ...
    assert("this is some text") in file_contents
    assert("text-align") in file_contents
...
def test_a():
    e = A("www.test.com", "this is linked text")

    file_contents = render_result(e).strip()

    assert("this is linked text") in file_contents
    assert("href=www.test.com") in file_contents
