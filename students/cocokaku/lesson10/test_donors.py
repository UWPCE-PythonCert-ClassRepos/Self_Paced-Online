...
(1) added 4 tests for donors challenge classmethod
(2) added 2 tests for donors total_value method
"""
...
# tests for donors challenge classmethod
def test_donors_challenge():
    db = Donors({"A Name": [1, 2, 3],
                 "B Name": [4, 5, 6]})
    db2 = Donors.challenge(db, 2)
