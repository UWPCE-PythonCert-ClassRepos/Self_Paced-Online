...
#Antonio Alvillar added (try/except with except going to the second item)
try:
...
#Antonio Alvillar added the try/except blocks.
try:
    more_joke = more_fun(langs[0])
except IndexError:
    try:
        more_joke = more_fun(langs[1])
    except IndexError: #Real world this would have to cover more possible types.
        print('Index Error Exception Found!')
    else:
        more_fun(langs[2])
finally:
    last_fun()
