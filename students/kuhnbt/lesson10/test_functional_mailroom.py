import unittest
import functional_mailroom as mr
...
class mailroomTest(unittest.TestCase):
    ...
    def test_challenge(self):
        self.d.add_donation(500)
        self.d.add_donation(1500)
        donor2 = mr.Donor('George', donations = [100, 4000])
        self.collection.add_donor(donor2)
        new_collection = self.collection.challenge(3, 200, 2000)
        new_collection.sum_all_donations()
        self.assertEqual(new_collection.sum_of_donations, 6000)