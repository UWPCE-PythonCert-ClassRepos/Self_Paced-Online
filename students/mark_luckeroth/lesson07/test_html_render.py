...
def test_sub_element2():
    ...
    """
    page = Html()
    page.append(Head(Title("PythonClass = Revision 1087:")))
    paragraph1 = P("Here is a paragraph of text")
    paragraph2 = P("And here is another piece of text")
    body1 = Body(paragraph1)
    ...
    expected = ['<!DOCTYPE html>', '<html>', '    <head>',
                ...
                '    </head>', '    <body>', '        <p>',
                "            Here is a paragraph of text", '        </p>',
                '        <p>', '            And here is another piece of text',
                '        </p>', '    </body>', '</html>']
