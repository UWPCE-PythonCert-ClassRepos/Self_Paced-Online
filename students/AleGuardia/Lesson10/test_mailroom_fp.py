...
def test_get_donation_range():
    assert donors.get_donation_range(0,30000) == [15000,5000,25000,1000,30000,3499]


def test_challenge():
    assert donors.challenge(2,0,30000) == [30000, 10000, 50000, 2000, 60000, 6998]
    assert donors.challenge(5) == [5000000, 2925000, 28750000, 75000, 25000, 15000000,
                                   125000, 5000, 150000, 17495]


def test_get_total():
    assert get_total(donors.challenge(5)) == 52072495
