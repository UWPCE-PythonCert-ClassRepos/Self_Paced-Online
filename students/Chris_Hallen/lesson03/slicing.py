...
def exchange_first_last(seq):
    """ this function returns a copy of that sequence with the first and last items exchanged"""
...
def remove_every_other(seq):
    """ this function returns a copy of that sequence with every other item removed"""
...
def first_4_and_last_4_removed(seq):
    """
        this function returns a copy of that sequence
...
def reverse_elements(seq):
    """ this function returns a copy of that sequence with the elements reversed (just with slicing) """
    return seq[::-1]
