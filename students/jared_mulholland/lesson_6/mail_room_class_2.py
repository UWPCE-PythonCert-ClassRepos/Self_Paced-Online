...
class DonorGroup(object):
    ...
    def challenge(self, factor, min_donation=None, max_donation=None):
        get_donations = [[globals()[d.split(" ")[0].lower()].fullname, globals()[d.split(" ")[0].lower()].donation] for d in self.donor_list]
    ...
    def projection(self, factor, min_donation = None, max_donation = None):
        ...
        contribution = sum([sum(dg_factored.donor_dict[d]) for d in dg_factored.donor_list])
