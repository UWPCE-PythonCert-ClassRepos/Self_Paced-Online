#!/usr/bin/env python3
# Lesson 6, Mailroom reorganized to better support unit tests
        ...
        if donor_name == "list":
            ...
            while True:
                try:
                    ...
                    break
            print(record_donation(donor_name, amt))
            break
            
def record_donation(donor_name, amt):
    """
    Record the given donation information then 
    return the text for a thank you letter to the given donor for the given donation amount
    """
    ...
    return ltr_template.format(**record)
