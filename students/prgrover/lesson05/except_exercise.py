...
#Note: Exception = NameError: name 's' is not defined
try:
...
except IndexError:  #Note: Exception = IndexError: list assignment index out of range
	more_joke = more_fun(langs[1])
else:
	more_joke = more_fun(langs[2])  #Note: 'python' is not accounted for in more_fun(). NotImplementedError exception?
finally:
	last_fun()
