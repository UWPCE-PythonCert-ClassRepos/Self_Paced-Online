...
class TestCircle(unittest.TestCase):
    ...
    def test__add__(self):
        test_template = 'Circle({})'
        self.assertEqual(self.c1 + self.c3, test_template.format(2 + 6))
        self.assertEqual(self.c2 + self.c3, test_template.format(4.5 + 6))
    ...
    def test__iadd__(self):
        test_template = 'Circle({})'
        self.assertEqual(self.c1.__iadd__(self.c2), test_template.format(2 + 4.5))
    ...
    def test__mul__(self):
        test_template = 'Circle({})'
        self.assertEqual(self.c5 * 2, test_template.format(6 * 2))
        self.assertEqual(self.c2 * 5, test_template.format(4.5 * 5))
    ...
    def test__rmul__(self):
        test_template = 'Circle({})'
        self.assertEqual(2 * self.c5, test_template.format(6 * 2))
        self.assertEqual(5 * self.c2, test_template.format(4.5 * 5))

    def test__imul__(self):
        test_template = 'Circle({})'
        self.assertEqual(self.c3.__imul__(3), test_template.format(18))
        self.assertEqual(self.c2.__imul__(4), test_template.format(4.5 * 4))
