...
def summarize_donation():
    ...
    summarized_list = [{'donor_name': donor_key,
                        'total_given': sum(data_dict.get(donor_key)),
                        'num_gifts': len(data_dict.get(donor_key)),
                        'avg_gifts': (sum(data_dict.get(donor_key)) /
                                      max(len(data_dict.get(donor_key)), 1))
                        } for donor_key in data_dict.keys()]
