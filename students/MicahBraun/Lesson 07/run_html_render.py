...
image = hr.Img(source='src', alternate='', ht='height', wd='width', hspace='hspace')
image.append(hr.Img(source="https://i0.wp.com/blog.aeguana.com/wp-content/uploads/2014/12/python_logo_symbol.jpg",
                    alternate="Python logo", ht=280, wd=420, hspace=500))
body.append(image)
