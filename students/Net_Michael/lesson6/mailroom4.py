...
# given file_path (*/dornor_folder/first_last_suffix.txt) opens donor's file and extracts list of all donations.
# example file_path - */donor_folder/Paul_Allen.txt

def open_donor_file(file_path):
