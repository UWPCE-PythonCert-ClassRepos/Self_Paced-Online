...
def render_page(page, filename, indent=None):
    ...
    #            "but this is enough  to show that we can do some text v1")

    # page.append("And here is another piece of text -- you should be able to add any number v1")
    ...
    #                  "but this is enough  to show that we can do some text v2"))

    # body.append(hr.P("And here is another piece of text -- you should be able to add any number v2"))
...
list1 = hr.Ul(id="TheList", style="line-height:200%")

list1.append(hr.Li("The first item in a list"))
list1.append(hr.Li("This is the second item", style="color: red"))
...
def test_render_page_none(*page_none):
    pass
#
