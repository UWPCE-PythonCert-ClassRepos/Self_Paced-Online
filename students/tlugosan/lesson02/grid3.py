...
# For example, print_grid2(3,4) results in a 3 by 3 with 4 lines as the cell size
...
#    draw_grid3(1,-2)
    #block_size must be !=-1 throws ZeroDivisionError: integer division or modulo by zero
