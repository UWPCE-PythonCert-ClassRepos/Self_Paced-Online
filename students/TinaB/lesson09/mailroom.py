...
"""Updated Mailroom Script with classes
$ chmod +x mailroom.py
"""
...
mailroom = DonorFunctions([donor1, donor2, donor3, donor4, donor5, donor6])
...
MAIN_MENU = {
    ...
    "4": {'menu_prompt': 'Test Print All', 'menu_dispatch': mailroom.print_letters_to_everyone},
...
SINGLE_PRINT_SUB_MENU = {
    ...
    "3": {'menu_prompt': 'Print Donors and All Donations', 'menu_dispatch': mailroom.print_donors_and_donations},
    "4": {'menu_prompt': 'Print Donors and Donation Totals', 'menu_dispatch': mailroom.print_donors_and_donation_totals},
