...
""" Task 3 - Rewrite the following: "the 3 numbers are: {:d}, {:d}, {:d}".format(1,2,3)
...
""" Task 6 - print a table of several rows, each with a name, an age and a cost. """
tbl = list()
tbl.append(("God's Balls", 29, 1000))
tbl.append(("Salt Lick", 28, 2500))
tbl.append(("8-Way Santa", 27, 50000))
tbl.append(("Inhaler", 25, 11000000))
tbl.append(("Infrared Riding Hood", 23, 9004))

for t in tbl:
    print("{:<20}  {:>3d}  ${:<15.2f}".format(*t))
