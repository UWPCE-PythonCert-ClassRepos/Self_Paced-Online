...
class MailroomTest(unittest.TestCase):
    ...
    def test_run_projection(self):
        self.assertEqual(mailroom4fp.run_projection(donor='Cerf',
                         contrib_ceiling=100000, factor=2), 100000)
        self.assertEqual(mailroom4fp.run_projection(donor='Gates',
                         contrib_floor=50000, factor=3), 900000)
