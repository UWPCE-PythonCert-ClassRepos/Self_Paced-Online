...
donor_dict = defaultdict(lambda : [0, 0, 0], {'Bob Dylan': [20000.00, 3, 40000.00], 'Leonard Cohen' : [600.00, 2, 300.00], 'Soren Kierkegaard' : [1000.00, 2, 500.00], 'Italo Calvino' : [15000.00, 4, 5000.00], 'Florence Feist' : [300.00, 3, 100.00]})
...
def add_donor_to_dict(name):
    ...
    if donor_dict[name.title()][1] == 0:
        print(f"{name.title()} is a new donor.")
