...
if __name__ == "__main__":
    ...
    l = len(days)
    print (("\tThere are {} days in a week.\n\tThey are:" + ', '.join(["{}"] *l) ).format(l, *days))

    print ("\nTASK 4")
    print ("Format using index")
    print ("\tThe new order is \n\t'{3} {4} {2} {0} {1}'".format(4, 30, 2017, 2, 27))
    ...
    table = (line0, line1, line2, line3, line4, line5, line6, line7, line8, line9, line10)
    ...
    for idx, line in enumerate(table):
        ...
        else: print(("{:2}  " + "{:<20}{:>3}{:>30}").format(idx, *line))
