...
hr = importlib.import_module("13_Html_Render_L7_FP", package = None)
...
#------------------------------------------------
def test_attributes():
    p = P("this is some text", style = 'text-align: center; font-style oblique;', id = 'intro')
    ...
    assert "text-align: center; font-style oblique;" in file_contents
...
def test_append_content_ul():
    ul = Ul(id = "TheList", style = "line-height : 200%")
    ul.append("the first item in the list")
    file_contents = render_result(ul)
    print(file_contents)

#------------------------------------------------
def test_content_li():
    li = Li("the first item in the list")
    file_contents = render_result(li).strip()
    print(file_contents)
    
    assert "the first item in the list" in file_contents
    assert file_contents.startwith("<li>")
    assert file_contents.endwith("</li>")
...
def test_element_indent1():
    """
    Tests whether the Element indents at least simple content we are expecting to to look like this:
