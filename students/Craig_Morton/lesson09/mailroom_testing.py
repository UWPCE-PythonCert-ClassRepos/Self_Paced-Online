# ------------------------------------------------- #
# Title: Lesson 9, mail room 5 testing
# Dev:   Craig Morton
# Date:  9/27/2018
# Change Log: CraigM, 9/27/2018, mail room 5 testing
# ------------------------------------------------- #
...
class DBTest(unittest.TestCase):
    ...
    def test_thank_you(self):
        ...
        expected = "Thank you Test This for your generous donation of $100.00"
        letter = mailroom_behavior.send_thank_you(db, "Test", "This", 100)
        self.assertEqual(letter, expected)

        expected = "Thank you Test This for your generous donation of $32.00"
        letter = mailroom_behavior.send_thank_you(db, "Test", "This", 32)
        self.assertEqual(letter, expected)
